...
<nav>
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?php if($this->router->fetch_class()=="audit"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/audit/index'); ?>"><i class="icon_table"></i>Audit</a></li>
<li <?php if($this->router->fetch_class()=="auditor"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/auditor/index'); ?>"><i class="icon_table"></i>Auditor</a></li>
<li <?php if($this->router->fetch_class()=="financial_year"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/financial_year/index'); ?>"><i class="icon_table"></i>Financial Year</a></li>
